    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hemis_id', models.CharField(blank=True, max_length=255, null=True, unique=True)),
                ('face_id', models.CharField(max_length=400)),
                ('three_name', models.CharField(blank=True, max_length=255, null=True)),
